...
final class InitCommand extends AbstractCommand
{
    ...
    private function generateMigrations(Output $output): void
    {
        ...
        $context = [
            ...
            'admin_tokens'               => $this->buildAdminPermissionTokens(),
        ];
     ...
     */
    private function buildAdminPermissionTokens(): array
    {
        $prefix = (string) getenv('ADMIN_PERMISSION_TOKEN_PREFIX');

        return [
            'user_create' => [
                'permission_token' => $prefix . 'USER_CREATE',
                'permission_title' => 'Create Users',
                'notes'            => 'Allows creating new user accounts.',
            ],
            'user_read' => [
                'permission_token' => $prefix . 'USER_READ',
                'permission_title' => 'Read Users',
                'notes'            => 'Allows reading user account records.',
            ],
            'user_update' => [
                'permission_token' => $prefix . 'USER_UPDATE',
                'permission_title' => 'Update Users',
                'notes'            => 'Allows updating user account information.',
            ],
            'user_delete' => [
                'permission_token' => $prefix . 'USER_DELETE',
                'permission_title' => 'Delete Users',
                'notes'            => 'Allows deleting user accounts.',
            ],
            'user_password_reset' => [
                'permission_token' => $prefix . 'USER_PASSWORD_RESET',
                'permission_title' => 'Reset User Passwords',
                'notes'            => 'Allows issuing password resets for user accounts.',
            ],
            'user_group_create' => [
                'permission_token' => $prefix . 'USER_GROUP_CREATE',
                'permission_title' => 'Create User Groups',
                'notes'            => 'Allows creating new user groups.',
            ],
            'user_group_read' => [
                'permission_token' => $prefix . 'USER_GROUP_READ',
                'permission_title' => 'Read User Groups',
                'notes'            => 'Allows reading user group records.',
            ],
            'user_group_update' => [
                'permission_token' => $prefix . 'USER_GROUP_UPDATE',
                'permission_title' => 'Update User Groups',
                'notes'            => 'Allows updating user group information.',
            ],
            'user_group_delete' => [
                'permission_token' => $prefix . 'USER_GROUP_DELETE',
                'permission_title' => 'Delete User Groups',
                'notes'            => 'Allows deleting user groups.',
            ],
            'user_group_membership_create' => [
                'permission_token' => $prefix . 'USER_GROUP_MEMBERSHIP_CREATE',
                'permission_title' => 'Create User Group Memberships',
                'notes'            => 'Allows adding users to user groups.',
            ],
            'user_group_membership_read' => [
                'permission_token' => $prefix . 'USER_GROUP_MEMBERSHIP_READ',
                'permission_title' => 'Read User Group Memberships',
                'notes'            => 'Allows reading user group membership records.',
            ],
            'user_group_membership_update' => [
                'permission_token' => $prefix . 'USER_GROUP_MEMBERSHIP_UPDATE',
                'permission_title' => 'Update User Group Memberships',
                'notes'            => 'Allows modifying user group membership access status.',
            ],
            'user_group_membership_delete' => [
                'permission_token' => $prefix . 'USER_GROUP_MEMBERSHIP_DELETE',
                'permission_title' => 'Delete User Group Memberships',
                'notes'            => 'Allows removing users from user groups.',
            ],
            'permission_create' => [
                'permission_token' => $prefix . 'PERMISSION_CREATE',
                'permission_title' => 'Create Permissions',
                'notes'            => 'Allows creating new permission records.',
            ],
            'permission_read' => [
                'permission_token' => $prefix . 'PERMISSION_READ',
                'permission_title' => 'Read Permissions',
                'notes'            => 'Allows reading permission records.',
            ],
            'permission_update' => [
                'permission_token' => $prefix . 'PERMISSION_UPDATE',
                'permission_title' => 'Update Permissions',
                'notes'            => 'Allows updating permission records.',
            ],
            'permission_delete' => [
                'permission_token' => $prefix . 'PERMISSION_DELETE',
                'permission_title' => 'Delete Permissions',
                'notes'            => 'Allows deleting permission records.',
            ],
            'permission_set_create' => [
                'permission_token' => $prefix . 'PERMISSION_SET_CREATE',
                'permission_title' => 'Create Permission Sets',
                'notes'            => 'Allows creating new permission sets.',
            ],
            'permission_set_read' => [
                'permission_token' => $prefix . 'PERMISSION_SET_READ',
                'permission_title' => 'Read Permission Sets',
                'notes'            => 'Allows reading permission set records.',
            ],
            'permission_set_update' => [
                'permission_token' => $prefix . 'PERMISSION_SET_UPDATE',
                'permission_title' => 'Update Permission Sets',
                'notes'            => 'Allows updating permission set records.',
            ],
            'permission_set_delete' => [
                'permission_token' => $prefix . 'PERMISSION_SET_DELETE',
                'permission_title' => 'Delete Permission Sets',
                'notes'            => 'Allows deleting permission sets.',
            ],
            'permission_set_permission_create' => [
                'permission_token' => $prefix . 'PERMISSION_SET_PERMISSION_CREATE',
                'permission_title' => 'Add Permissions to Permission Sets',
                'notes'            => 'Allows associating permissions with permission sets.',
            ],
            'permission_set_permission_read' => [
                'permission_token' => $prefix . 'PERMISSION_SET_PERMISSION_READ',
                'permission_title' => 'Read Permission Set Permissions',
                'notes'            => 'Allows reading permission associations within permission sets.',
            ],
            'permission_set_permission_delete' => [
                'permission_token' => $prefix . 'PERMISSION_SET_PERMISSION_DELETE',
                'permission_title' => 'Remove Permissions from Permission Sets',
                'notes'            => 'Allows removing permissions from permission sets.',
            ],
            'permission_set_member_create' => [
                'permission_token' => $prefix . 'PERMISSION_SET_MEMBER_CREATE',
                'permission_title' => 'Add Users to Permission Sets',
                'notes'            => 'Allows assigning users directly to permission sets.',
            ],
            'permission_set_member_read' => [
                'permission_token' => $prefix . 'PERMISSION_SET_MEMBER_READ',
                'permission_title' => 'Read Permission Set Members',
                'notes'            => 'Allows reading user assignments within permission sets.',
            ],
            'permission_set_member_delete' => [
                'permission_token' => $prefix . 'PERMISSION_SET_MEMBER_DELETE',
                'permission_title' => 'Remove Users from Permission Sets',
                'notes'            => 'Allows removing users from permission sets.',
            ],
            'permission_set_user_group_create' => [
                'permission_token' => $prefix . 'PERMISSION_SET_USER_GROUP_CREATE',
                'permission_title' => 'Assign User Groups to Permission Sets',
                'notes'            => 'Allows assigning user groups to permission sets.',
            ],
            'permission_set_user_group_read' => [
                'permission_token' => $prefix . 'PERMISSION_SET_USER_GROUP_READ',
                'permission_title' => 'Read Permission Set User Group Assignments',
                'notes'            => 'Allows reading user group assignments within permission sets.',
            ],
            'permission_set_user_group_delete' => [
                'permission_token' => $prefix . 'PERMISSION_SET_USER_GROUP_DELETE',
                'permission_title' => 'Remove User Groups from Permission Sets',
                'notes'            => 'Allows removing user groups from permission sets.',
            ],
        ];
    }
}
