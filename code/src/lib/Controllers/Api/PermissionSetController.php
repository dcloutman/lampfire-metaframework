...
class PermissionSetController extends AbstractRestController
{
    ...
    public function get(Request $request, Response $response): Response
    {
        ...
        return $this->jsonResponse($response, ['data' => $sets]);
    }
    ...
    public function getById(Request $request, Response $response): Response
    {
        ...
        if ($set === null) {
            return $this->jsonError($response, 404, 'Not Found', 'The requested permission set does not exist.');
        }

        return $this->jsonResponse($response, ['data' => $set]);
    }
    ...
    public function post(Request $request, Response $response): Response
    {
        ...
        $token = $this->extractString($body, 'permission_set_token');
        $title = $this->extractString($body, 'title');
        ...
        try {
            ...
            return $this->jsonResponse($response, ['data' => $set], 201);
