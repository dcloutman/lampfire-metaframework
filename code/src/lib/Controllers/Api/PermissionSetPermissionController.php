...
class PermissionSetPermissionController extends AbstractRestController
{
    ...
    public function get(Request $request, Response $response): Response
    {
        ...
        return $this->jsonResponse($response, ['data' => $associations]);
    }
    ...
    public function getById(Request $request, Response $response): Response
    {
        ...
        if ($association === null) {
            return $this->jsonError($response, 404, 'Not Found', 'The requested association does not exist.');
        }

        return $this->jsonResponse($response, ['data' => $association]);
    }
    ...
    public function post(Request $request, Response $response): Response
    {
        ...
        $permissionId = $this->extractString($body, 'permission_id');
        ...
        try {
            ...
            return $this->jsonResponse($response, ['data' => $association], 201);
