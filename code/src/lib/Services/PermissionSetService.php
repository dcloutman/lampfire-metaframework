 ...
 * and PermissionSetGroupMembers. Validates inputs, enforces
...
use App\Gateways\PermissionGateway;
use App\Gateways\PermissionSetGateway;
use App\Gateways\PermissionSetGroupMemberGateway;
use App\Gateways\PermissionSetMemberGateway;
use App\Gateways\PermissionSetPermissionGateway;
use App\Gateways\UserGateway;
use App\Gateways\UserGroupGateway;
...
class PermissionSetService extends AbstractService
{
    ...
    private PermissionSetGroupMemberGateway $setGroupMemberGateway;
     ...
     * @param PermissionSetGroupMemberGateway $setGroupMemberGateway Gateway for PermissionSetGroupMembers.
    ...
    public function __construct(
        ...
        PermissionSetGroupMemberGateway $setGroupMemberGateway,
    ...
    // ----------------------------------------------------------------
    // PermissionSetGroupMembers (group-to-set memberships)
    // ----------------------------------------------------------------
